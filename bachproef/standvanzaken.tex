...
\begin{itemize}
    ...
    \item \textbf{Graph-based en machine learning-gebaseerde correlatie}: geavanceerde technieken waarbij relaties tussen events worden gemodelleerd als grafstructuren of waarbij algoritmen automatisch patronen leren detecteren.
\end{itemize}
...
Door AI-gerelateerde dreigingen — zoals prompt injection of data-exfiltratie via LLM’s — te mappen op bestaande aanvalstactieken, kan correlatie verfijnd worden. Threat intelligence maakt het mogelijk om:
