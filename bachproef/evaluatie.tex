...
\begin{itemize}
    \item \textbf{End-to-End zichtbaarheid:} Er wordt beoordeeld of de Dynatrace OneAgent in staat is om de volledige interactieketen succesvol vast te leggen in één overkoepelende trace.
