...
\textit{Hoe kan een geïntegreerd framework op basis van Dynatraces Audit Logging en Akamai’s Firewall for AI worden ontworpen om AI-chatbotinteracties volledig traceerbaar en beveiligd te maken, met behoud van privacy en naleving van GDPR?}\\
...
\begin{itemize}
    ...
    \item Welke soorten aanvallen of verdachte inputs kan Akamai’s firewall for AI detecteren en blokkeren tijdens chatbotverkeer? 
...
\begin{itemize}
    ...
    \item Welke type aanvallen of risicovolle inputs detecteert Akamai’s firewall for AI het meest effectief, en hoe kunnen deze detecties worden teruggekoppeld naar Dynatrace voor correlatie?
...
\begin{itemize}
    ...
    \item beschermd wordt door een firewall for AI (Akamai) die verdachte of kwaadaardige prompts detecteert en filtert;
...
In Hoofdstuk~\ref{ch:risicoanalyse} wordt onderzocht wat de risico's zijn en een baseline vastgesteld.\\

In Hoofdstuk~\ref{ch:poc} wordt de Proof of Concept uitgewerkt en stap voor stap beschreven.\\

In Hoofdstuk~\ref{ch:Evaluatie} wordt beschreven hoe de resultaten geëvalueerd zullen worden.\\

In Hoofdstuk~\ref{ch:resultaten} worden de resultaten beschreven en beoordeeld aan de hand van het vorige hoofdstuk.\\

In Hoofdstuk~\ref{ch:conclusie}, tenslotte, wordt de conclusie gegeven en een antwoord geformuleerd op de onderzoeksvragen. Daarna volgt nog een kort Hoofdstuk~\ref{ch:discussie} met daarin enkele bevindingen en aanbevelingen voor aanvullend onderzoek.
