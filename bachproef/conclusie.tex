...
Dit geïntegreerde framework levert hiermee een betrouwbare vorm van \textit{audit trail} en \textit{chain-of-evidence} op. Aangezien elk event en elke blokkering aan een specifieke sessie gekoppeld is, is de reconstructie van incidenten achteraf reproduceerbaar en juridisch verdedigbaar.\\
